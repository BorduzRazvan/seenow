...
import work.seenow.seenow.databinding.ProfileItemBinding;

public class PostsAdapter extends RecyclerView.Adapter<PostsAdapter.MyViewHolder> {

    private List<ProfileItem> postList;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(final ProfileItemBinding itemBinding) {
    ...
    public PostsAdapter(List<ProfileItem> postList, PostsAdapterListener listener) {
    ...
    public interface PostsAdapterListener {
        void onPostClicked(ProfileItem post);
    }
}